...
def sniff_packets():
    ...
    # Call the packet sniffer script
    os.system('python tools/sniffer/packet-sniffer.py')

    # Assuming the packet sniffer script saves results to a file
    with open('sniffer_results.txt', 'r') as file:
        packets = file.read()
